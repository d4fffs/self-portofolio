<x-app-layout>
    <section class="px-4 md:px-8 lg:px-16 py-12 mt-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-10">
            @php
                $cards = [
                    ['label' => 'Total Produk', 'value' => $totalProduk, 'color' => 'text-blue-400', 'icon' => 'cube'],
                    ['label' => 'Total Stok', 'value' => $totalStok, 'color' => 'text-green-400', 'icon' => 'archive'],
                    ['label' => 'Total Harga', 'value' => 'Rp ' . number_format($totalHarga, 0, ',', '.'), 'color' => 'text-yellow-400', 'icon' => 'cash'],
                    ['label' => 'Produk Kosong', 'value' => $produkKosong, 'color' => 'text-red-400', 'icon' => 'x-circle'],
                ];
        ...
        <div class="bg-gray-800 p-6 rounded-xl shadow">
            <h2 class="text-lg md:text-xl font-semibold text-white mb-4 text-center md:text-left">Visualisasi Stok Produk</h2>
